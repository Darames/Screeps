...
var roleTransporter = {
    ...
    run: function(creep) {
	    ...
	    if(!creep.memory.delivering) {
            ...
            //     if(variables.container(creep)[i].store[RESOURCE_ENERGY] < variables.container(creep)[i].storeCapacity && !variables.container(creep)[i].pos.inRangeTo(creep.room.controller, 3)) {
