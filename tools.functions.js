...
var moveTo = {
    ...
    sourceContainer: function(creep) {
        ...
        // } 
        if(!sourceContainer.length || sourceContainer[0].store[RESOURCE_ENERGY] < (creep.carryCapacity*2)) {
            var droppedResource = _.sortBy(variables.droppedResources(creep), s => creep.pos.getRangeTo(s));
